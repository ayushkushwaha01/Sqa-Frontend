...
import { SamplePopComponent } from 'src/app/pages/sqm/inspect-inner-screen/active-records-ref/sample-pop/sample-pop.component';
import { UploadListComponent } from 'src/app/pages/sqm/inspect-inner-screen/active-records-ref/upload-list/upload-list.component';
import { UploadstagepopComponent } from 'src/app/pages/sqm/inspect-inner-screen/active-records-ref/uploadstagepop/uploadstagepop.component';
...
@Component({
  selector: 'app-ins-active-ref',
  templateUrl: './ins-active-ref.component.html',
  styleUrls: ['./ins-active-ref.component.scss']
})
export class InsActiveRefComponent implements OnInit {
